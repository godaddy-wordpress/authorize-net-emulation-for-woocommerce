...
/**
 * Authorize.Net Emulation bundled Parsedown class.
 *
 * This is a bundle & namespaced copy of the Parsedown library http://parsedown.org.
 * The reason this is bundled with the plugin is to avoid possible version conflicts in the WordPress environment when
 * requiring the original package as a composer dependency.
 *
 * (c) Emanuil Rusev
 * http://erusev.com
 *
